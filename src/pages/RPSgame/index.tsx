...
export const ResultContext = createContext<{
    result: string | null, setResult: React.Dispatch<React.SetStateAction<string | null>>
} | null>(null);

const metaData:MetaProps = {
    fontUrl: "https://fonts.googleapis.com/css2?family=Barlow+Semi+Condensed:wght@700&display=swap",
    title: "Rock, Paper and Scissor Game",
    desc:"Rock, Paper and Scissor game using React Js",
    keywords: "Game using React js, React App, Rock, paper and scissor game using React Js, React Js game"
}
            ...
            <div className="container-lg py-5">
                <header className={`${styles.game_header} w-75 mx-auto row`}>
                    ...
                    <div className="col p-0">
                        <div className={`${styles.score_box} float-end text-center d-flex flex-column justify-content-between`}>
