    ...
    return(
        <>
            <form onSubmit={handleIconClick}>
                ...
                <button type="submit" className={`${styles.game_icon} ${big && styles[bigIcon]} ${styles[coinCss]} ${classes} rounded-circle`}>
                    <div className={`${styles.inner_coin_bg} d-flex justify-content-center align-items-center`}>
