  ...
  return (
    <div className={`${styles.job_card} ${featured && styles.featured} mb-4`}>
      <div className="row">
        ...
        <div
          className={`${styles.content_area} col-lg-4 d-flex flex-column justify-content-between align-items-start`}
        >
        ...
        <div
          className={`${styles.tag_area} col-lg-6 d-flex align-items-center justify-content-end`}
        >
