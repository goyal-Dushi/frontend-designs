...
const GameResult: React.FC<GameResultProps> = ({ setScore }) => {
  ...
  return (
    <div
      className={`${styles.result_container} container-sm d-flex align-items-center justify-content-center px-0`}
    >
      <div className="row w-100">
        ...
        <div
          className={`${styles.res_text_container} col-lg-4 col-12 order-lg-2 order-3 p-0 d-flex align-items-center justify-content-center flex-column`}
        >
          {winText && (
            <>
